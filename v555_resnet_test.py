...
[image_order,image_name,image,image_raw,label],batch_size=BATCH_SIZE,capacity=500,num_threads=1)  #参数设多少
...
with tf.Session() as sess:
    ...
    net, end_points = resnet_v2.resnet_v2_101(X,is_training=False,global_pool=False)  #得到最后一个block的输出
    ...
    saver.restore(sess,'D:/jupyter_pycode/buildings/11111/v5_resnet_101/trial_model.model')
