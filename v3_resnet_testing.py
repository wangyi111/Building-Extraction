...
with tf.Session() as sess:
    ...
    #初始化第一个全连接层的权值
    W_fc1=weight_variable([2048,256*2])  #上一层输出7*7*64个神经元，全连接层有1024个神经元
    ...
    saver.restore(sess,'D:/jupyter_pycode/buildings/11111/v3_resnet_softmax_onehot_noBN_81000/trial_model.model')
