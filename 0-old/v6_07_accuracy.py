...
start=time.clock()
predict_dir="D:/jupyter_pycode/buildings/33333/cnn/predict_result/"
label_dir="D:/jupyter_pycode/buildings/33333/Target Maps/"
output_dir="D:/jupyter_pycode/buildings/33333/cnn/accuracy.txt"
#获取所有图片
...
def predict_accuracy(filenames,predict_dir,label_dir,output_dir):
    ...
    all_accuracy=sum(total_nums)/(width2*height2)
